...
```
这样就不会受限制,可以完美使用桌面版协议了（2021-5-20记录，以后会怎样说不准）。详见<https://wechaty.js.org/2021/04/13/wechaty-uos-web/>

#### 主要功能
1. 每日一句
  - 使用spider爬取<http://wufazhuce.com/>的内容
2. 今日天气
3. 热点话题
4. 机器人聊天
